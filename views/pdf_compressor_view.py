...
def process_and_compress_pdf(pdf_data, pdf_name, folder_name, temp_dir, gs_setting, zf, stats):
    """PDF ဖိုင်တစ်ခုချင်းစီကို ဖိသိပ်ပြီး Folder အလိုက် ZIP အတွင်းသို့ ပြန်ထည့်ပေးမည့် လုပ်ငန်းစဉ်"""
...
def render_pdf_compressor_ui():
    ...
    st.write("PDF ဖိုင်များကို လိုအပ်သော အရည်အသွေး (Quality) အလိုက် ရွေးချယ်၍ ဖိုင်ဆိုဒ် (Size) သေးသွားအောင် ဖိသိပ်ပေးသောစနစ်")
